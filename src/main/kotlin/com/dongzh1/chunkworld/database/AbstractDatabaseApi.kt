...
abstract class AbstractDatabaseApi(ormlite: Ormlite) {
    ...
    //获取最近上线的1000名玩家的数据
    fun playerGetFirst(): List<PlayerDao> {
        playerDao.queryBuilder().orderBy("lastTime", false).limit(1000)
    ...
    fun chunkGet(id: Int): List<ChunkDao> =
        chunkDao.queryForEq("playerID", id)
